...
def _normalize_single_content_v17_4_9_v2(content_str):
    ...
    if len(nums) >= 2:
        ...
        # [V17.4.0.9] 최신 지침 반영 (앞단 생략, 뒷단 보존)
...
if __name__ == "__main__":
    ...
    print(f"{'Input':<15} | {'V17.4.0.9 (V2) Result'}")
    print("-" * 45)
    for tc in test_cases:
        res = _normalize_single_content_v17_4_9_v2(tc)
        print(f"{tc:<15} | {res}")
