...
- `python -m pytest tests/rebaseline -q`: **112 passed in 5.49s** (pytest cache directory permission warning 1건).
- `python -m pytest tests/test_common_normalization.py -q`: **6 passed in 0.22s**.
