...
- `python -m pytest tests/rebaseline/test_collectors.py -q`: **30 passed** (실제 PyMuPDF PDF의 Section 3 별도 셀 행, Section 1 동일 행 label/value 셀 뒤 multiline 및 company 종료 회귀 포함).
- `python -m pytest tests/rebaseline -q`: **129 passed in 7.02s**.
