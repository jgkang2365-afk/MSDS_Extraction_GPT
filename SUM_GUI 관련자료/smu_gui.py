...
import msds_engine_v7 as engine
...
class SMUGUI(QMainWindow):
    ...
    def _create_extraction_page(self):
        ...
        self.table.setHorizontalHeaderLabels([
            ...
            "측정대상", "2차 결과(규제)", "1차 결과(전체)", "파일명", "Hash"
        ])
        ...
        self.table.setColumnHidden(7, True); self.table.setColumnHidden(8, True)
    ...
    def reload_engine(self):
        ...
        try:
            ...
            import msds_engine_v7
            importlib.reload(msds_engine_v7)
    ...
    def add_result_to_table(self, data):
        ...
        try:
            ...
            self.table.setItem(row, 7, item_fn)

            # 9. 해시 (숨김) - [NEW] 캐시 업데이트용
            f_hash = data.get("f_hash", "")
            item_hash = QTableWidgetItem(f_hash)
            self.table.setItem(row, 8, item_hash)
